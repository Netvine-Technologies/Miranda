...
class LeadDiscoveryController extends Controller
{
    public function index(): View
    {
        ...
        return view('leads.discovery', [
            ...
            // Representative English-speaking markets across the working day.
            // Time is evaluated in the browser so the overview remains current
            // while the user keeps the page open.
            'englishSpeakingMarkets' => [
                ['name' => 'London', 'country' => 'United Kingdom', 'location' => 'London, United Kingdom', 'timezone' => 'Europe/London'],
                ...
                ['name' => 'Auckland', 'country' => 'New Zealand', 'location' => 'Auckland, New Zealand', 'timezone' => 'Pacific/Auckland'],
            ],
        ]);
    }
